...
const EditProfile = () => {
  ...
  return (
    <div className="container mt-5" style={{ maxWidth: '800px',backgroundColor:'#007bff' }}>
      <div className="card" style={{ borderColor: '#007bff', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', backgroundColor: '#007bff' }}>
        <div className="card-body" style={{ padding: '2rem' }}>
          ...
          <button 
            ...
            style={{ backgroundColor: '#007b00', borderColor: '#007bff' }}
